        ...
        <section class="special_area p_100">
        	<div class="container">
        		<div class="main_title">
        			...
        			<h5>At your cake bakery, indulge in a variety of delectable cakes that will tantalize your taste buds. From classic vanilla to decadent chocolate, our menu features a range of flavors and styles to suit every occasion and craving. Come and savor the sweetness today!</h5>
        		</div>
...
?>
							...
							<div class="col-lg-8">
								<div class="special_item_text">
									...
									<p><strong>Price:</strong> Rs <?php echo $row['ItemPrice'];?></p>
