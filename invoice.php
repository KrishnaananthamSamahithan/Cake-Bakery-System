...
<?php  
$oid=$_GET['oid'];
$query=mysqli_query($con,"select tblorderaddresses.OrderTime,tblfood.Image,tblfood.ItemName,tblfood.Weight,tblfood.ItemPrice,tblorders.FoodId,tblorders.OrderNumber,tblorders.customer_note from tblorders 
...
<tr>
 ...
 <td><img src="admin/itemimages/<?php echo $row['Image'];?>" width="60" height="40" alt=""></td> 
  <td><?php echo $row['ItemName'];?></td>   
   ...
   <td>Rs <?php  echo $total=$row['ItemPrice'];?></td> 
