...
$query="update tblorders set OrderNumber='$orderno',IsOrderPlaced='1',CashonDelivery='$cod', customer_note='$note' where UserId='$userid' and IsOrderPlaced is null;";
                	...
                	<div class="col-lg-7">
                		...
                		<div class="billing_form_area">
                			<form class="billing_form row" action="" method="post" id="contactForm">
                                ...
                                <div class="form-group col-md-12">
                	                <label><h4>Please Enter any Note if You Have</h4></label>
					                <textarea name="note" id="note" cols="30" rows="10" class="form-control" placeholder="Enter the Notes"></textarea>
				                </div>
...
?>
									<h5><?php echo $row['ItemName']?> <span>Rs <?php echo $total=$row['ItemPrice']?>
									<?php 
$grandtotal+=$total;
$cnt=$cnt+1; 
                           
 ?></span></h5><?php $cnt++; } }?>
									<h4>Subtotal <span>Rs <?php echo $grandtotal;?></span></h4>
									<h5>Shipping And Handling<span class="text_f">Free Shipping</span></h5>
									<h3>Total <span>Rs <?php echo $grandtotal;?></span></h3>
								</div>
