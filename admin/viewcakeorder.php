...
<div class="col-6" style="margin-top:2%">
  <?php  
$query=mysqli_query($con,"select tblfood.Image,tblfood.ItemName,tblfood.ItemDes,tblfood.ItemPrice,tblfood.ItemQty,tblorders.FoodId,tblorders.CashonDelivery,tblorders.customer_note from tblorders join tblfood on tblfood.ID=tblorders.FoodId where tblorders.IsOrderPlaced=1 and tblorders.OrderNumber='$oid'");
...
<tr>
  ...
  <td>Rs <?php  echo $total=$row1['ItemPrice'];?></td> 
  <td><?php echo $row1['customer_note'];?></td>
</tr>
<?php 
$grandtotal+=$total;
$cnt=$cnt+1;} ?>
